...
<body>
                            ...
                            <form method="POST" action="{{ route('login.verify-number') }}" id="login-form">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <p class="mt-3 mb-5" id="password_text">Prefer to Sign in with password instead? <a
                                            ...
                                            onclick="showPasswordDiv()">Click Here</a></p>
    ...
    {{-- Password Login Script - Webreca Technologies --}}
    <script>
    ...
    {{-- OTP Login Script - Webreca Technologies --}}
    <script>
        function showOTPField() {
            ...
            $('.other-login-options').show();
            $('#login-form').attr('action', '{{ route('login.verify-number') }}');
        }
    </script>

    {{-- On Password Login Error Show Password Div Script - Webreca Technologies --}}
    @error('password')
        <script>
