        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0 mt-0">
               <div class="wizard-breakdown-image">
                <h2 class="text-danger text-center pt-3 mb-0 pb-0 fw-bold">{{ config('app.name', 'Laravel') }}</h2>
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr class="border-border-none border-top-none">
                                ...
                                <td class="text-end fs-14"><a href="javascript:void(0)" class="text-decoration-none text-primary"><i class="bi bi-pencil-square"></i></a></td>
                            </tr>
                            <tr class="border-border-none border-top-none">
